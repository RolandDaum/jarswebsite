...
export default function Navbar() {
    ...
    return (
        <nav className="Navbar" class="h-fit w-screen pt-10 flex flex-col justify-center items-center bg-background select-none TBP:p-0">
            ...
            <div className={`${navbarOpen ? 'flex' : 'hidden'} flex-col justify-start items-center h-full w-screen absolute left-0 top-24 bg-background bg-opacity-50 backdrop-blur pt-10`}>
                <NavLink to="" class="">
