...
export default function WhyCard( { textIndex } ) {
    ...
    return (
        <div class=" w-full py-14 px-10 mx-5 bg-primary-default rounded h-full flex flex-col justify-start items-center">
            <img src={text[textIndex].icon} class="h-20"></img>
            <h1 class=" font-bodonimt text-text text-4xl under my-8">{text[textIndex].title}</h1>
